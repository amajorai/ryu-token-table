...
import { handLabel, stakesLabel } from "./table-copy.ts";
import type {
	HistoryEntry,
	PlayerSeat,
	PokerAction,
	...
	return (
		<aside aria-label="Hand history" className="poker-history-popover">
			<div className="poker-history-popover__header">
				<div>
					<span className="poker-hand-label">{handLabel(handNumber)}</span>
					<h2>Hand history</h2>
				</div>
...
function BuyInPanel({
	...
	return (
		<div className="poker-join-panel">
			...
			<span className="poker-hand-label">
			...
			<div className="token-table-app">
				<RyuAppToolbar
					actions={
						<div className="poker-toolbar-actions">
							<span className="poker-hand-number">
								{handLabel(snapshot.handNumber)}
							</span>
							<PopoverTrigger
								render={
									<Button
				...
				>
					<span className="poker-toolbar-stakes">
						{stakesLabel(snapshot.smallBlind, snapshot.bigBlind)}{" "}
						<span aria-hidden="true">⌄</span>
					</span>
				</RyuAppToolbar>
